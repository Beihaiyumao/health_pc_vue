	...
	<div>
		<el-table stripe v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
		 element-loading-background="rgba(0, 0, 0, 0.8)" :data="BMIResultList" tyle="width: 150%">
			...
			<el-table-column prop="resultMsg" label="结果内容" width="200">
			</el-table-column>
			<el-table-column prop="proposal" label="医生建议" width="240">
			</el-table-column>
		...
		<el-dialog title="修改BMI结果" :visible.sync="dialogFormVisible">
